...
SF6Mode::SF6Mode() : ControllerMode(socd::SOCD_NEUTRAL) {
    _socd_pair_count = 2;
...
void SF6Mode::HandleSocd(InputState &inputs) {
    InputMode::HandleSocd(inputs);
}

void SF6Mode::UpdateDigitalOutputs(InputState &inputs, OutputState &outputs) {
    // Menu keys
...
void SF6Mode::UpdateAnalogOutputs(InputState &inputs, OutputState &outputs) {
